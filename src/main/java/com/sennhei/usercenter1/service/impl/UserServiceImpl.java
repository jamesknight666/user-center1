package com.sennhei.usercenter1.service.impl;
...
import com.sennhei.usercenter1.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    public static final String SALT="sennhei";
    ...
    public User getSafetyUser(User originalUser){
        ...
        safetyUser.setEmail(originalUser.getPlanetCode());
        safetyUser.setUserRole(originalUser.getUserRole());
        safetyUser.setUserState(originalUser.getUserState());
